...
//     GL_CLAMP_TO_EDGE); return textureRef;
// }
...
//     SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y); if (textureRef == 0) cout <<
//     "didnt find texture file " << texImagePath << endl;
//     // ----- mipmap/anisotropic section
//     glBindTexture(GL_TEXTURE_2D, textureRef);
//     glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER,
//     GL_LINEAR_MIPMAP_LINEAR); glGenerateMipmap(GL_TEXTURE_2D); if
